...
CREATE TABLE `urgent_care` (
  `urgent_care_id` bigint(20) NOT NULL AUTO_INCREMENT,
  `created_at` datetime(6) DEFAULT NULL,
  `last_modified_at` datetime(6) DEFAULT NULL,
  `content` varchar(255) NOT NULL,
  `patient_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`urgent_care_id`),
  KEY `FKcirukv6iwl7s25sekm32q3efl` (`patient_id`),
  CONSTRAINT `FKcirukv6iwl7s25sekm32q3efl` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`patient_id`)
